...
- % 할인 쿠폰:
  ...
  - special_condition에 "X%할인 최대 N,000원" 형식으로 기록. (예: "5%할인 최대 3,000원")
  - 이것은 할인 쿠폰이지 적립이 아님. "적립" 문구 절대 추가 금지.
- 브랜드 적립 혜택 (별도 레코드로 추출):
  - 브랜드 상세 페이지에서 "최대 N% 추가적립" 또는 "브랜드 적립 N%" 항목이 있으면
    별도 레코드로 추출. discount: 0, special_condition: "브랜드 적립 N%"
  - 예시:
    {
      "app": "요기요",
      "brand": "자담치킨",
      ...
      "method": "전체",
      "delivery_types": [],
      "special_condition": "브랜드 적립 5%",
      "valid_until": null
    }
  - 할인 쿠폰 레코드와 별개임. 적립은 쿠폰과 함께 섞지 말 것.
- 선착순 쿠폰:
